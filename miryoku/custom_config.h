...
&sk LGUI,          &sk LALT,          &sk LCTRL,         &sk LSHFT,         &kp RET,           &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp RIGHT,         &kp PG_DN,         \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP

#define MIRYOKU_LAYER_MOUSE \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      &u_to_U_SYM,       U_NU,              U_WH_L,            U_MS_U,            U_WH_R,            U_WH_U,            \
&sk LGUI,          &sk LALT,          &sk LCTRL,         &sk LSHFT,         U_NA,              U_NU,              U_MS_L,            U_MS_D,            U_MS_R,            U_WH_D,            \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
...
&kp SEMI,          &kp N4,            &kp N5,            &kp N6,            &kp EQUAL,         &kp PLUS,          &sk LSHFT,         &sk LCTRL,         &sk LALT,          &sk LGUI,          \
...
&kp COLON,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          &kp EQUAL,         &sk LSHFT,         &sk LCTRL,         &sk LALT,          &sk LGUI,          \
...
&kp F11,           &kp F4,            &kp F5,            &kp F6,            &kp SLCK,          U_NA,              &sk LSHFT,         &sk LCTRL,         &sk LALT,          &sk LGUI,          \
